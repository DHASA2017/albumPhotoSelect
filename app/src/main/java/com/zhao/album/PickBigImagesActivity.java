...
public class PickBigImagesActivity extends Activity implements ViewPager.OnPageChangeListener, View.OnClickListener{
    ...
    protected void initFindView() {
        ...
        tv_choose_finish.setOnClickListener(new View.OnClickListener() {
        ...
        if(last_pics < total_pics) {
            ...
            tv_choose_finish.setText(String.format(getString(R.string.choose_pic_finish_with_num), total_pics - last_pics, total_pics));
        }
    }
