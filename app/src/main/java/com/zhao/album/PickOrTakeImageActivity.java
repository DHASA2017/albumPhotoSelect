...
public class PickOrTakeImageActivity extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener,
    ...
    private TextView tv_choose_finish;
    private FrameLayout fl_choose_image_directory;
...
//        window.setBackgroundDrawable(getResources().getDrawable(R.color.white));
        ...
        findViewById(R.id.rl_title_left).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        tv_choose_finish = (TextView) findViewById(R.id.tv_choose_finish);
        fl_choose_image_directory = (FrameLayout) findViewById(R.id.fl_choose_image_directory);
        rl_title_right = (RelativeLayout) findViewById(R.id.rl_title_right);
        rl_title_right.setOnClickListener(new View.OnClickListener() {
    ...
    protected void initData() {
        ...
        fl_choose_image_directory.setOnClickListener(this);
        ...
        if (picNums == 1){
            ...
            tv_choose_finish.setVisibility(View.GONE);
        }else{
            tv_choose_finish.setText("完成");
        }
    }
...
//                Uri uri = MediaStore.Images.Media.EXTERNAL_CONTENT_URI;
                ...
                Cursor cursor = contentResolver.query(uri, null, null, null, MediaStore.MediaColumns.DATE_MODIFIED+" desc");
                if (cursor != null){
                    allImages.clear();
                    while (cursor.moveToNext()){
                        ...
                        if(isVideo(mimetype)){
                            singleImageModel.duration = cursor.getLong(cursor.getColumnIndex("duration"));
                            singleImageModel.isVideo = true;
//                            singleImageModel.thumbnailPath = cursor.getString(cursor.getColumnIndex(MediaStore.Video.Media.Th))
//                            singleImageModel.path = cursor.getString(cursor.getColumnIndex(MediaS))
                        }
                        if(isImage(mimetype)){
                        ...
                        //存入按照目录分配的list
                        if(singleImageModel.path!=null&&!"".equals(singleImageModel.path)){
    ...
    public void onClick(View view) {
        int i = view.getId();
        if (i == R.id.fl_choose_image_directory) {//                window.showAsDropDown(tv_choose_image_directory);
            if (Build.VERSION.SDK_INT < 11) {
...
//                i--;
            ...
            if (bitmap != null){
                ...
                holder.iv_content.setBackgroundResource(R.drawable.pictures_no);
            }
            return view;
        }
    }
    ...
    private class ListviewAdapter extends BaseAdapter{
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (bitmap != null){
                ...
                holder.iv_directory_pic.setBackgroundResource(R.drawable.pictures_no);
            }
            return view;
        }
    }
        ...
        public void onClick(View view) {
            ...
            if (i == R.id.iv_content) {
                ...
                if (getImageDirectoryModelStateFromMapById(position)) {
                    ...
                    currentPicNums++;
                    if (currentPicNums == 1) {
                        tv_choose_finish.setTextColor(getResources().getColor(R.color.white));
                    }
                    tv_preview.setText(String.format(getString(R.string.preview_with_num), currentPicNums));
                    tv_choose_finish.setText(String.format(getString(R.string.choose_pic_finish_with_num), currentPicNums, picNums));
                } else {
                    ...
                    currentPicNums--;
                    if (currentPicNums == 0) {
                        tv_choose_finish.setTextColor(getResources().getColor(R.color.found_description_color));
                        tv_choose_finish.setText(getString(R.string.choose_pic_finish));
                        tv_preview.setText(getString(R.string.preview_without_num));
                    } else {
                        tv_preview.setText(String.format(getString(R.string.preview_with_num), currentPicNums));
                        tv_choose_finish.setText(String.format(getString(R.string.choose_pic_finish_with_num), currentPicNums, picNums));
...
//        finish();
    ...
    private ArrayList<SingleImageModel> getChoosePicFromList(){
        ...
        for (String path : picklist){
            SingleImageModel model = new SingleImageModel(path, true, 0, 0,path,0,false);
            list.add(model);
        }
        return list;
    }
